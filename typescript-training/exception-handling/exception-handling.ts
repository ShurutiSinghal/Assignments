...
/*
let input:any;
console.log(input.toLowerCase()) // gives error
console.log("Execution Done..") // code not executed
*/
...
catch(error)
{
    ...
    console.log(input.toUpperCase()); // throw error
}
finally {
    console.log("Execution completed"); // executed
}
